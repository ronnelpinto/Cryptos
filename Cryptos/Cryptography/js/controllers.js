...
function DESCtrl($scope,WordService,$http) 
{
  ...
  $scope.status = '';
   ...
   $scope.passkey = function()
   {
    ...
    $http.get('http://localhost/Cryptos/Cryptography/Backend/setkey.php',{params: {'n':$scope.UserId,'algoid':$scope.AlgoId,'algoname':$scope.Algoname,'key':$scope.passphraseKey}
