...
<div class="container">
  <div class="row">
   ...
   <?php $id=$_GET['n']; echo $id; ?>
    <div class="span12">
      <p class="Status {{desStatus}}" ng-show="feedBackOfEncryption != ''">{{feedBackOfEncryption}}</p>
    </div>
    
    <div class="span12">
      <h2>Enter a custom key or <a ng-click="newPassPhrase();">generate random key</a></h2>
      <textarea class="input-xlarge" id="passphrasekey" ng-model="passphraseKey" placeholder=""></textarea>
	  ...
	  <button type="submit" ng-click="passkey()" class="btn btn-primary" ng-disabled="messageInput == ''">pass key<i class="icon-arrow-right icon-white"></i></button>
    </div>
