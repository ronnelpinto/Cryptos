...
<div class="container">
  <div class="row">
    ...
    <form name="input" action="http://localhost/Cryptos/Cryptography/#/phrases?algoid=2&algoname=DES&n={{UserId}}" method="get">
	       <input type="submit" value="Generate a new key">
     </form>
	 
	 <form name="input2" action="http://localhost/Cryptos/Cryptography/Backend/getkey.php?algoid=2&algoname=DES&n={{UserId}}" method="post">
